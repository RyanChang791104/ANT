...
namespace ANT_
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureABT()
        {
            ...
            {
                RichBox_Result.AppendText("Channel opened\n");
            }
            else
            {
        ...
        private void result_display(ANT_Response response)
        {
            ...
            Packet_Show.Content = packet.Count;
        ...
        {
            RichBox_Result.ScrollToEnd();
            RichBox_Result.AppendText("Channel0 has closed");
        }
                ...
                if (Packet_combox.SelectedIndex >= 0)
                {
                    switch (Packet_combox.SelectedIndex)
                    {
                        case 0:
                            ...
                            RichBox_Result.AppendText("TX: " + Convert.ToString(BitConverter.ToString(Broadcast50)) + "\n");
                            break;

                        case 1:
                            channel0.sendBroadcastData(Broadcast51);
                            FileStreamWriteFile(null, Broadcast51);
                            RichBox_Result.AppendText("TX: " + Convert.ToString(BitConverter.ToString(Broadcast51)) + "\n");
                            break;

                        case 2:
                            channel0.sendBroadcastData(Broadcast52);
                            FileStreamWriteFile(null, Broadcast52);
                            RichBox_Result.AppendText("TX: " + Convert.ToString(BitConverter.ToString(Broadcast52)) + "\n");
                            break;
                    }
                }
            }
